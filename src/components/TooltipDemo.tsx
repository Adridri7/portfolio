...
export function ToolTipCard() {
  return (
    ...
    <div className="grid  max-w-md justify-center text-foreground md:grid-cols-2 [&>div]:relative [&>div]:flex [&>div]:h-[137px] [&>div]:w-[224px] [&>div]:items-center [&>div]:justify-center [&>div]:p-4 transition-all  duration-300 ease-out group-hover:scale-105">
      <div>
